...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <!-- End of Topbar -->
                ...
                <h2 class="h3 mb-2 text-gray-800">Form Edit Data Stok Barang</h2>
                <?php
	include 'koneksi.php';
	$id = $_GET['id'];
	$data = mysqli_query($koneksi,"select * from stokbarang where id='$id'");
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputEmail3" name="stok" value="<?php echo $d['stok']; ?>">
    </div>
  </div>
  <div class="row mb-3">
