                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                          <a href="tambahkeluar.php" class="btn btn-primary">Tambah Data</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    while($d = mysqli_fetch_array($data)){
                                      ?>
                                        <tr>
                                            ...
                                            <th>
                                              <a href="editkeluar.php?id=<?php echo $d['id']; ?>" class="btn btn-success">Edit</a>
                                              <a href="hapusmasuk.php" onclick="confirmDelete('hapusmasuk.php?id=<?php echo $d['id']; ?>')" class="btn btn-danger">Hapus</a>
                                            </th>
                                            <?php
                                              }
                                            ?>
